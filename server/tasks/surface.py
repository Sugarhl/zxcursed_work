...
def create_md_description(A, B, C):
    md = "Даны три точки в пространстве A(" + ", ".join(map(str, A)) + "), B(" + ", ".join(map(str, B)) + "), C(" + ", ".join(map(str, C)) + "). "
    md += "Составить уравнение плоскости ABC, систему параметрических уравнений прямой AB и прямой AM, перпендикулярной плоскости ABC."
    return md
